...
public class StaticShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/main/java/lr7/shaders/vertexShader.txt";
    private static final String FRAGMENT_FILE = "src/main/java/lr7/shaders/fragmentShader.txt";
